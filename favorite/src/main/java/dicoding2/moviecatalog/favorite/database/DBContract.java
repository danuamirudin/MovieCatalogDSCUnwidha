package dicoding2.moviecatalog.favorite.database;

import android.database.Cursor;
import android.net.Uri;
import android.provider.BaseColumns;

import static dicoding2.moviecatalog.favorite.utilities.Static.*;

public class DBContract {
    private static final String AUTHORITY = "dicoding1.moviecatalog";
